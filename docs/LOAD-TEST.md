...
2. The viewport + index design is the primary scaler. Bbox, tile, list, and latest-per-
...
- Tenant isolation and pruning: each crisis's data is physically separate; a query for one
