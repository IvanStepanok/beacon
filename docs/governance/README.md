...
The core principle across all four: the aggregate is sensitive even when every individual record is anonymised. Never publish raw location clusters; coarsen to P-code for any external view; gate fine-grained geolocation behind least-privilege RBAC. See also the system-level [OPERATIONAL-MODEL.md](../OPERATIONAL-MODEL.md).
